  ...
  return (
    <nav className={`sticky top-0 ${cinturonActual.bg} border-b-4 ${cinturonActual.border} p-4 z-50 shadow-lg transition-colors duration-500`}>
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        {/* Logo y Nombre */}
        <div className={`text-base md:text-2xl font-black tracking-wide flex items-center gap-2 ${cinturonActual.texto}`}>
          <Image
            src="/logo/pixel-academia.png"
            alt="Logo Taekwondo Llan-Do"
            width={76}
            height={76}
            className="object-contain w-12 h-12 md:w-[76px] md:h-[76px]"
          />
          <span className="whitespace-nowrap">TAEKWONDO <span className={cinturonActual.llandoColor}>LLAN-DO</span></span>
        </div>
